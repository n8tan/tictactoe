...
function play() {
	...
	do {
		...
		secondPlottingUserInput(userMove,move);
		moves++;
		//console.log("Incremented the move variable.");
		//console.log("About to enter the second do while");
		do{

			//debugger;
			//console.log("Entering the second do while");
			computerMove = attackFunction(move,userMove);
			computerAttackFunction(computerMove,move);
			moves++;

			//console.log("called computerMove & computerAttackFunction");
			...
			secondPlottingUserInput(userMove,move);
			moves++;
			//console.log("called secondPlottingUserInput");
			if(moves == 9) {
				console.log("\n\t\t It's a draw." + "\n");
				break;
			}
	...
	function attackFunction(move,userMove) {
		...
		console.log("Regular Move Thinking");
		for(var i=0; i<3; i++) {
